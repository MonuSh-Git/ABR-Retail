...
const About = () => {
  return (
    <section className="py-16 px-4 md:px-10 bg-gray-800 lg:px-20 overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] group">
          ...
          <motion.img
            ...
            className="absolute top-0 left-0 w-[75%] rounded-2xl shadow-xl z-10 
          ...
          <motion.img
            ...
            className="absolute bottom-0 right-0 w-[60%] rounded-2xl shadow-2xl border-4 border-white z-20
                       transition-all duration-500 
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-50 mb-4 leading-snug">
          ...
          <a
            href="/about"
            className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-green-700 transition duration-300"
          >
            About More
          </a>
        </motion.div>
